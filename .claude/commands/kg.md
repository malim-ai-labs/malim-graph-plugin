...
4. **Visualization**: Run the **Sigma.js Visualizer** skill to generate a high-performance interactive map:
   ```bash
...
- **High-Performance Visualization**: Use `skills/graph-visualizer-sigma/scripts/visualize_sigma.py` for WebGL-powered interactive explorers (GitNexus stack).
