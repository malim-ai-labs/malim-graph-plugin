...
from malimgraph.core.pdf_reader import DocumentContent, PageContent, _extract_page, extract_text_from_pdf
        ...
        "blocks": [
            {
                ...
                "lines": [
                    {
                        "spans": [
                            {"text": "Chapter 1: Introduction", "size": 14, "flags": 16}
                        ]
                    }
                ],
            }
...
def test_document_content_full_text():
    ...
    pages = [
        PageContent(page_number=1, text="Page one text.", headings=[], blocks=[], has_table=False, is_scanned=False),
        PageContent(page_number=2, text="Page two text.", headings=[], blocks=[], has_table=False, is_scanned=False),
    ]
    doc = DocumentContent(source_file="test.pdf", total_pages=2, title="Test", metadata={}, pages=pages)
    full = doc.full_text()
